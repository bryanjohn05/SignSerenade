  ...
  const initHolistic = () => {
    ...
    holistic.onResults((results: any) => {
      ...
      if (results.faceLandmarks) {
        connect(results.faceLandmarks, win.FACEMESH_TESSELATION, "#a600a6", 1)
        draw(results.faceLandmarks, "#fdeed1", 1, 1)
      }
      ...
      for (const hand of hands) {
        if (hand.data) {
          connect(hand.data, win.HAND_CONNECTIONS, "#0000ff", 2) // green lines
          draw(hand.data, "#00fe00", 3, 2) // red points
        }
      }
    })
